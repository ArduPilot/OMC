...
LT_STATUS DecodeJP2ToMemory()
{
   ...
   TEST_SUCCESS(reader->initialize(fileSpec, false));
   ...
   FILE* fp = fopen(OUTPUT_PATH("meg_cr20_jp2.raw"), "wb");
   TEST_BOOL(fp != NULL);
   ...
   TEST_BOOL(Compare(OUTPUT_PATH("meg_cr20_jp2.raw"), INPUT_PATH("meg_cr20_jp2.raw")));

   Remove(OUTPUT_PATH("meg_cr20_jp2.raw"));
