...
public class OGLRenderToTextureSupport
{
    ...
    private int lastBoundFramebuffer;
    ...
    protected void beginFramebufferObjectRendering(DrawContext dc)
    {
        ...
        GL gl = dc.getGL();
        gl.glGetIntegerv(GL.GL_FRAMEBUFFER_BINDING, framebuffers, 0);
        lastBoundFramebuffer = framebuffers[0];
    ...
    protected void endFramebufferObjectRendering(DrawContext dc)
    {
        ...
        GL gl = dc.getGL();
        gl.glBindFramebuffer(GL.GL_FRAMEBUFFER, lastBoundFramebuffer);
