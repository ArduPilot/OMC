...
public class PerformanceStatistic implements Comparable<PerformanceStatistic>
{
    ...
    public static final String DRAW_CALLS = "gov.nasa.worldwind.perstat.DrawCalls";
    public static final String READ_PIXELS_COUNT = "gov.nasa.worldwind.perstat.ReadPixelsCount";
