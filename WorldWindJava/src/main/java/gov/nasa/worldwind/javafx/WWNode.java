...
public class WWNode extends Region implements WorldWindow, EventSink
{
    ...
    public WWNode()
    {
        ...
        wwd.initGpuResourceCache(WWContext.getInstance().getSharedGpuResourceCache());
    ...
    {
        this.setInputHandler(new JfxInputHandler(true, true));
    }
    ...
    {
        cachedModel = model;
        accept(() -> wwd.setModel(model), false);
    }
    ...
    public void setSceneController(SceneController sceneController)
    {
        ...
        accept(() -> wwd.setSceneController(sceneController), false);
    }
