    ...
    private void renderFrame(GLAutoDrawable glAutoDrawable) {
        ...
        try {
            ...
            if (!gl.isInitialized() || lastDrawable != autoDrawable) {
                ...
                helper = new GLHelper(this, autoDrawable.getGL().getGL3());
            ...
            if (recreateFramebuffer) {
                ...
                helper.checkError(
                    "glRenderbufferStorage(GL_RENDERBUFFER, GL_RGBA, " + currentWidth + ", " + currentHeight + ")");
                ...
                helper.checkFramebuffer(GL2.GL_FRAMEBUFFER);
            }
            ...
            sc.getDrawContext()
                .setPerFrameStatistic(PerformanceStatistic.DRAW_CALLS, PerformanceStatistic.DRAW_CALLS, drawCalls);
