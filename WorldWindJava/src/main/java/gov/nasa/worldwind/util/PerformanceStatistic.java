...
public class PerformanceStatistic implements Comparable<PerformanceStatistic>
{
    ...
    public static final String DRAW_CALLS = "gov.nasa.worldwind.perfstat.DrawCalls";
    public static final String READ_PIXELS_COUNT = "gov.nasa.worldwind.perfstat.ReadPixelsCount";
    public static final String FRAMES_RENDERED = "gov.nasa.worldwind.perfstat.FramesRendered";
