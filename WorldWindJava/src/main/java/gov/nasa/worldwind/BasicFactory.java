...
public class BasicFactory implements Factory
{
    ...
    public Object createFromConfigSource(Object configSource, AVList params)
    {
        ...
        try
        {
            ...
            {
                o = this.doCreateFromElement((Element) configSource, params, true);
            }
            ...
            else
            {
                ...
                if (doc != null)
                    o = this.doCreateFromElement(doc.getDocumentElement(), params, true);
            }
        }
        catch (Exception e)
        {
    ...
    protected Object doCreateFromElement(Element domElement, AVList params, boolean legacy) throws Exception
    {
        return null;
    }
}
