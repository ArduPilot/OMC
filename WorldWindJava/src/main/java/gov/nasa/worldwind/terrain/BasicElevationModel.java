...
//**************************************************************//
    ...
    protected static class RequestTask implements Runnable
    {
        ...
        public RequestTask(TileKey tileKey, BasicElevationModel elevationModel)
        {
    ...
    public boolean loadElevations(ElevationTile tile, java.net.URL url) throws Exception
    {
        BufferWrapper elevations = this.readElevations(url, tile);
    ...
    protected BufferWrapper readElevations(URL url, Tile tile) throws Exception
    {
        try
        {
    ...
    public void downloadElevations(final Tile tile)
    {
    ...
    public void retrieveRemoteElevations(final Tile tile, DownloadPostProcessor postProcessor)
    {
    ...
    public static class Elevations
    {
        ...
        public Elevations(BasicElevationModel elevationModel, double achievedResolution)
        {
            this.elevationModel = elevationModel;
        ...
        public Double getElevation(Angle latitude, Angle longitude)
        {
            ...
            try
            {
                ...
                {
                    if (tile.getSector().contains(latitude, longitude)){ //&& tile.getElevations() != null) {
                        double elev = this.elevationModel.lookupElevation(latitude, longitude, tile);
                        return elev;
                    }
                }
        ...
        public double[] getExtremes(Sector sector)
        {
            if (this.extremes != null)
                return this.extremes;
        ...
        public void setTiles(Set<ElevationTile> tiles){
            this.tiles = tiles;
        }
        public Collection<ElevationTile> getTiles(){
            return this.tiles;
        }
    }
...
//    }
    ...
    protected void startResourceRetrieval()
    {
        ...
        }, "Capabilities retrieval for " + this.getName());
        t.setDaemon(true);
