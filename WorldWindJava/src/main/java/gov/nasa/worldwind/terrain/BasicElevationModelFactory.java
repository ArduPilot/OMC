...
public class BasicElevationModelFactory extends BasicFactory
{
     ...
     */
    @Override
    protected ElevationModel doCreateFromElement(Element domElement, AVList params, boolean legacy) throws Exception
    {
        ...
        if (elements != null && elements.length > 0)
            ...
            return this.createNonCompoundModel(domElement, params, legacy);
    ...
    protected CompoundElevationModel createCompoundModel(Element[] elements, AVList params)
    {
        ...
        for (Element element : elements)
        {
            try
            {
               /* ElevationModel em = this.doCreateFromElement(element, params, true);
                if (em != null)
                    compoundModel.addElevationModel(em);
*/
                ElevationModel em2 = this.doCreateFromElement(element, params, false);
                if (em2 != null)
                    compoundModel.addElevationModel(em2);
            }
            catch (Exception e)
            {
