...
import com.intel.missioncontrol.persistence.insight.primitives.AnnotationResponse;
import com.intel.missioncontrol.persistence.insight.primitives.Annotations;
import com.intel.missioncontrol.persistence.insight.primitives.Camera;
...
import com.intel.missioncontrol.persistence.insight.primitives.FlightPlans;
import com.intel.missioncontrol.persistence.insight.primitives.Flights;
import com.intel.missioncontrol.persistence.insight.primitives.Mission;
import com.intel.missioncontrol.persistence.insight.primitives.Missions;
import com.intel.missioncontrol.persistence.insight.primitives.Project;
import com.intel.missioncontrol.persistence.insight.primitives.ProjectLastChangesResponse;
import com.intel.missioncontrol.persistence.insight.primitives.ProjectResponse;
import com.intel.missioncontrol.persistence.insight.primitives.Projects;
import com.intel.missioncontrol.persistence.insight.primitives.Search;
import com.intel.missioncontrol.persistence.InsufficientRightsException;
...
import com.intel.missioncontrol.persistence.UnauthorizedException;
...
public final class InsightDaoImpl {
    ...
    public InsightDaoImpl(InsightContext insightContext) {
        this.host = InsightConfig.getInstance().insightHostProperty();
        this.headers = insightContext.headersProperty();
        insightLoggedIn.bind(InsightConfig.getInstance().insightLoggedInProperty());
    }
    ...
    private void analyzeStatus(HttpResponse httpResponse) {
        int status = httpResponse.getStatus();
        if (status == CODE_UNAUTHORIZED) {
            throw new UnauthorizedException();
        }

        if (status == CODE_SERVICE_UNAVAILABLE) {
    ...
    public final FlightPlans searchAllFlightPlansInMission(@NotNull String missionId, @NotNull String projectId) {
        ...
        HttpResponse httpResponse =
            Unirest.post(this.host.get() + this.UISRV + "flight-plan/search")
                .headers(this.headers.get())
                .body(this.gson.toJson(searchRequest))
                .asString();
