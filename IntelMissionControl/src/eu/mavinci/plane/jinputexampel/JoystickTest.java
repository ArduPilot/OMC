...
public class JoystickTest {
    ...
    public static void main(String args[]) {
        System.setProperty("java.library.path", "C:\\Users\\ekorotko\\Documents\\trunk\\MAVinciDesktopWin\\lib64\\");
    ...
    public JoystickTest() {
        ...
        if (!foundControllers.isEmpty()) startShowingControllerData();
        else window.addControllerName("No controller found!");
    }

    /**
     * Search (and save) for controllers of type Controller.Type.STICK, Controller.Type.GAMEPAD, Controller.Type.WHEEL
     * and Controller.Type.FINGERSTICK.
     */
        ...
        while (true) {
            ...
            for (int i = 0; i < components.length; i++) {
                ...
                if (componentIdentifier
                        .getName()
                        .matches(
                            "^[0-9]*$")) { // If the component identifier name contains only numbers, then this is a
                                           // button.
                    // Is button pressed?
                ...
                if (component.isAnalog()) {
                    ...
                    if (componentIdentifier == Identifier.Axis.X) {
                        ...
                        System.out.println("X value: " + axisValue);
                        continue; // Go to next component.
                    }
                    // Y axis
                    if (componentIdentifier == Identifier.Axis.Y) {
                        yAxisPercentage = axisValueInPercentage;
                        System.out.println("Y value: " + axisValue);
                        continue; // Go to next component.
                    }
    ...
    /**
     * Given value of axis in percentage. Percentages increases from left/top to right/bottom. If idle (in center)
     * returns 50, if joystick axis is pushed to the left/top edge returns 0 and if it's pushed to the right/bottom
     * returns 100.
     *
