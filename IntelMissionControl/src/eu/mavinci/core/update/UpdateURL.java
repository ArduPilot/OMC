...
public class UpdateURL {
    ...
    public static final String DEV_EMAIL_MAVINCI = "http://www.apache.org/licenses/LICENSE-2.0";
    public static final String ENTERPRISE_EMAIL = "http://www.apache.org/licenses/LICENSE-2.0";
    ...
    public static URL getUpdateURLRevision(
            ...
            throws Exception {
        return new URL(getBaseString(serialNo, updateTarget, currentMajor, currentVersion));
    }
    ...
    public static int getRevision(
            String serialNo, EnumUpdateTargets updateTarget, String currentMajor, int currentVersion) {
        try {
    ...
    public static int getRevision(String serialNo, EnumUpdateTargets updateTarget) {
    ...
    public static String getHumanReadableVersion(String majorVersion, long revision) {
        return getHumanReadableMajor(majorVersion) + ".b" + revision;
    }
