...
public interface IFlightplanFactory {
    ...
    public abstract CStartProcedure newCStartProcedure(int id);

    public abstract CStartProcedure newCStartProcedure(int id, IFlightplanContainer parent);

    public abstract CStartProcedure newCStartProcedure(IFlightplanContainer parent);
    ...
    public abstract CPreApproach newPreApproach(double lon, double lat, int altInCm, int id);

    public abstract IFlightplanStatement newPreApproach(
            double lon, double lat, int defaultAltWithinCm, IFlightplanContainer parent);
