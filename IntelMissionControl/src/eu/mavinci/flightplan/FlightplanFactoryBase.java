...
public class FlightplanFactoryBase implements IFlightplanFactory {
    ...
    @Override
    public CStartProcedure newCStartProcedure(int id) {
        return new StartProcedure(id);
    }

    @Override
    public CStartProcedure newCStartProcedure(int id, IFlightplanContainer parent) {
        return new StartProcedure(parent, id);
    }

    @Override
    public CStartProcedure newCStartProcedure(IFlightplanContainer parent) {
        return new StartProcedure(parent);
    }
    ...
    @Override
    public CPreApproach newPreApproach(double lon, double lat, int altInCm, int id) {
        return new PreApproach(lon, lat, altInCm, id);
    }

    @Override
    public IFlightplanStatement newPreApproach(double lon, double lat, int altWithinCm, IFlightplanContainer parent) {
        return new PreApproach(lon, lat, altWithinCm, parent);
    }
