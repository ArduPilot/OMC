    ...
    public double distance(List<FlightplanVertex> list) {
        ...
        for (FlightplanVertex next : list) {
            ...
            if (lastDirection != null) {
                distance += MathHelper.acosFast(lastDirection.dot3(nextDirection)) * directionChangeRadToMeterPanelty;
            }
        ...
        if (lastDirection != null) {
            ...
            //					distance += Math.acos(MathHelper.intoRange(lastDirection.dot3(nextDirection),-1,1)); //TODO find a
            // good scale translation from radians to meters
            distance +=
                MathHelper.acosFast(lastDirection.dot3(nextDirection)); // TODO find a good scale translation to meters
        }
