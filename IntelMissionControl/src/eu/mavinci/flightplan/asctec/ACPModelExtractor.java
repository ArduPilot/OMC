...
public class ACPModelExtractor {
    ...
    private void add(CStartProcedure point) {
        // use the height of the startprocedure as the takeoff height -- now its always 15meters
        ...
        double lat = takeoffLocation.latitude.degrees;
        double lon = takeoffLocation.longitude.degrees;
    ...
    private void add(LandingPoint point) {
        ...
        double height = point.getAltInternalWithinM();
        int reentryId = point.getId();
