...
public class ExpressionBuilder {
     ...
     * 
     * @param function
     *            the custom {@link net.objecthunter.exp4j.function.Function} implementation that should be available for use in the
     *            expression.
     ...
     * 
     * @param functions
     *            the custom {@link net.objecthunter.exp4j.function.Function} implementations
     * @return the ExpressionBuilder instance
     */
     ...
     * 
     * @param functions
     *            A {@link java.util.List} of custom {@link net.objecthunter.exp4j.function.Function} implementations
     * @return the ExpressionBuilder instance
     */
     ...
     * 
     * @param operator
     *            the custom {@link net.objecthunter.exp4j.operator.Operator} to add
     * @return the ExpressionBuilder instance
     */
     ...
     * 
     * @param operators
     *            the set of custom {@link net.objecthunter.exp4j.operator.Operator} implementations to add
     * @return the ExpressionBuilder instance
     */
     ...
     * 
     * @param operators
     *            the {@link java.util.List} of custom {@link net.objecthunter.exp4j.operator.Operator} implementations to add
     * @return the ExpressionBuilder instance
     */
