...
public interface IMissionManager {
    ...
    Mission openMission(IMissionInfo missionInfo);
    ...
    boolean isMissionEmpty(IMissionInfo mission);

    boolean isMissionCloneable(IMissionInfo mission);
    ...
    AsyncListProperty<IMissionInfo> recentMissionInfosProperty();
