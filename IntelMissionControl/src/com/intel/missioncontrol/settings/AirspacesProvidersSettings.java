...
public class AirspacesProvidersSettings implements ISettings {
    ...
    private final AsyncStringProperty airmapApiKey =
            new SimpleAsyncStringProperty(this, new PropertyMetadata.Builder<String>().initialValue("").create());
    ...
    public AsyncStringProperty airmapApiKeyProperty() {
        return airmapApiKey;
    }
