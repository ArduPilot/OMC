...
public class ToastView extends ViewBase<ToastViewModel> {
    ...
    public void initializeView() {
        ...
        actionLink.disableProperty().bind(viewModel.getActionCommand().notExecutableProperty());
        actionLink.setOnAction(event -> viewModel.getActionCommand().execute());
        ...
        actionCheckBox.disableProperty().bind(viewModel.getActionCommand().notExecutableProperty());
        actionCheckBox.setOnAction(event -> viewModel.getActionCommand().execute());
