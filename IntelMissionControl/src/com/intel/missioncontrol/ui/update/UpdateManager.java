...
public class UpdateManager implements IUpdateManager {
    ...
    public UpdateManager(
        ...
        build = versionProvider.getAppMajorVersion() + "." + currentVersion;
                ...
                Dispatcher.post(
                    () -> {
                        if (isAnyUpdateAvailable()) {
                            ...
                            Dispatcher.postToUI(this::showDialogInternal);
                        }
                    });
            },
            Duration.seconds(10));
    ...
    private void downloadComplete(EnumUpdateTargets target, File file) throws Exception {
        ...
        if (activeDownloadResponses.isEmpty()) {
            Dispatcher.postToUI(this::installUpdates);
        }
    }
    ...
    private void installGuiUpdate() {
        ...
        Dispatcher.postToUI(() -> openFileAfterAppCloseConfirmed(guiUpdateFile));
    }
            ...
            .forEach(
                target -> {
                    ...
                    try {
                        ...
                        Integer skippedVersion =
                            MoreObjects.firstNonNull(updateSettings.skippedVersionsProperty().get(target), 0);
