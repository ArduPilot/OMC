...
public class ItemsView<T extends ViewModel> extends StackPane {
     ...
     */
    public <U extends T> void addViewFactory(Class<U> viewModelClass, Callback<U, Node> value) {
        Expect.notNull(viewModelClass, "viewModelClass", value, "value");
        viewFactories.put(viewModelClass, new Factory<>(value, null));
    }
    ...
    private void itemsChanged(
        ...
        if (oldItems != null) {
            oldItems.removeListener(this::itemsListChanged);
        ...
        if (newItems != null) {
            newItems.addListener(this::itemsListChanged);
