...
public class DialogService implements IDialogService, IKeepClassname {
    ...
    private static final String FILE_REPLACE_TITLE =
        "com.intel.missioncontrol.api.support.ConfirmationDialog.fileReplaceTitle";
    private static final String FILE_REPLACE_MESSAGE =
        "com.intel.missioncontrol.api.support.ConfirmationDialog.fileReplaceMessage";
    ...
    public <ViewModelType extends DialogViewModel> FluentFuture<ViewModelType> requestDialog(
        ...
        return requestDialogImpl(ownerViewModel, dialogViewModelClass, null, true, false);
    }
    ...
    public <ViewModelType extends DialogViewModel> FluentFuture<ViewModelType> requestDialog(
        ...
        Expect.notNull(
            ownerViewModel, "ownerViewModel",
            dialogViewModelClass, "dialogViewModelClass");
        return requestDialogImpl(ownerViewModel, dialogViewModelClass, null, modal, false);
    }
    ...
    public <ViewModelType extends DialogViewModel, PayloadType> FluentFuture<ViewModelType> requestDialog(
        ...
        return requestDialogImpl(ownerViewModel, dialogViewModelClass, payloadSupplier, true, false);
    }
    ...
    public <ViewModelType extends DialogViewModel, PayloadType> FluentFuture<ViewModelType> requestDialog(
        ...
        Expect.notNull(
            ...
            dialogViewModelClass, "dialogViewModelClass",
            payloadSupplier, "payloadSupplier");
        return requestDialogImpl(ownerViewModel, dialogViewModelClass, payloadSupplier, modal, false);
    }
    ...
    public <ViewModelType extends DialogViewModel> ViewModelType requestDialogAndWait(
        ...
        Expect.notNull(
            ownerViewModel, "ownerViewModel",
            dialogViewModelClass, "dialogViewModelClass");
        return Futures.getUnchecked(requestDialogImpl(ownerViewModel, dialogViewModelClass, null, true, true));
    }
    ...
    public <ViewModelType extends DialogViewModel, PayloadType> ViewModelType requestDialogAndWait(
        ...
        return Futures.getUnchecked(
            requestDialogImpl(ownerViewModel, dialogViewModelClass, payloadSupplier, true, true));
    }

    @SuppressWarnings("unchecked")
    private <ViewModelType extends DialogViewModel, PayloadType> FluentFuture<ViewModelType> requestDialogImpl(
            ViewModel ownerViewModel,
            Class<ViewModelType> dialogViewModelClass,
        ...
        if (!Platform.isFxApplicationThread()) {
            return Dispatcher.postToUI(
                    () -> requestDialogImpl(ownerViewModel, dialogViewModelClass, payloadSupplier, modal, wait))
                .unwrap();
        }
    ...
    public <ViewModelType extends ViewModelBase> FluentFuture<ViewModelType> requestPopoverDialog(
        ...
        if (!Platform.isFxApplicationThread()) {
            return Dispatcher.postToUI(
                    () -> requestPopoverDialog(ownerViewModel, popoverDialogViewModelClass, location))
                .unwrap();
        }
    ...
    public FluentFuture<String> requestInputDialog(
        ...
        return requestInputDialogImpl(
            ownerViewModel, title, message, null, new StringStringConverter(), allowEmptyValue, false);
    }
    ...
    public <T> FluentFuture<T> requestInputDialog(
            ...
            StringConverter<T> converter,
            boolean allowEmptyValue) {
        return requestInputDialogImpl(ownerViewModel, title, message, null, converter, allowEmptyValue, false);
    }
    ...
    public <T> T requestInputDialogAndWait(
            ...
            boolean allowEmptyValue) {
        var future =
            requestInputDialogImpl(ownerViewModel, title, message, defaultInput, converter, allowEmptyValue, true);
        if (future.isCancelled()) {
            return null;
        }
    ...
    private <T> FluentFuture<T> requestInputDialogImpl(
            ViewModel ownerViewModel,
            @Nullable String title,
            @Nullable String message,
            @Nullable String defaultInput,
    ...
    public void showInfoMessage(String title, String message) {
        Dispatcher.runOnUI(() -> showAlert(AlertType.INFORMATION, title, message, new ButtonType[] {ButtonType.OK}));
    }

    @Override
    public void showWarningMessage(String title, String message) {
        Dispatcher.runOnUI(() -> showAlert(AlertType.WARNING, title, message, new ButtonType[] {ButtonType.OK}));
    }

    @Override
    public void showErrorMessage(String title, String message) {
        Dispatcher.runOnUI(() -> showAlert(AlertType.ERROR, title, message, new ButtonType[] {ButtonType.OK}));
    }
    ...
    public boolean requestConfirmation(String title, String message) {
        Optional<ButtonType> result =
            Dispatcher.runOnUI(
                () ->
                    showAlert(
                        AlertType.CONFIRMATION, title, message, new ButtonType[] {ButtonType.YES, ButtonType.NO}));
    ...
    public DialogResult requestCancelableConfirmation(String title, String message, ButtonType[] buttons) {
        Optional<ButtonType> result =
            Dispatcher.runOnUI(() -> showAlert(AlertType.CONFIRMATION, title, message, buttons));
    ...
    public boolean requestFileOverwriteConfirmation(String file) {
        return requestConfirmation(
            languageHelper.getString(FILE_REPLACE_TITLE), languageHelper.getString(FILE_REPLACE_MESSAGE, file));
    }
    ...
    private Optional<ButtonType> showAlert(AlertType alertType, String title, String message, ButtonType[] buttons) {
        Alert alert = createAlert(alertType, title, message, buttons);
        setGenericStyle(alert);
        return alert.showAndWait();
    }

    private Alert createAlert(AlertType alertType, String title, String message, ButtonType[] buttons) {
        ...
        dialogPane
            ...
            .forEach(node -> ((Label)node).setPrefWidth(Region.USE_COMPUTED_SIZE));
        alert.setHeaderText(null);
        alert.setTitle("\n  " + title);
        VeryUglyDialogHelper.initModalityOrPutToFront(alert);
        return alert;
    }
