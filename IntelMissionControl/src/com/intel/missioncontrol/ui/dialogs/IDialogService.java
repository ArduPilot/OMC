...
public interface IDialogService {
     ...
     */
    <ViewModelType extends DialogViewModel> FluentFuture<ViewModelType> requestDialog(
     ...
     * IDialogContextProvider, the dialog will be in the scope hierarchy of the view model.
     */
    <ViewModelType extends DialogViewModel, PayloadType> FluentFuture<ViewModelType> requestDialog(
    ...
    <ViewModelType extends ViewModelBase> FluentFuture<ViewModelType> requestPopoverDialog(
    ...
    @Deprecated
    boolean requestConfirmation(String title, String message);
    ...
    @Deprecated
    boolean requestFileOverwriteConfirmation(String file);
