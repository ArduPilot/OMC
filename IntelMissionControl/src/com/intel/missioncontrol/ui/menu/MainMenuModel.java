    ...
    public static MenuModel create(ILanguageHelper languageHelper) {
        return MenuModel.build(
            ...
            MenuModel.menu(
                ...
                MenuModel.item(Debug.PERF_MONITOR, languageHelper.toFriendlyName(Debug.PERF_MONITOR)),
                MenuModel.group(MenuModel.checkItem(Debug.WIREFRAME, languageHelper.toFriendlyName(Debug.WIREFRAME)))));
    }
