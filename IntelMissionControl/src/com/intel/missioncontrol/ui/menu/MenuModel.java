...
public class MenuModel {
    ...
    /**
     * Set the command handler for this menu item. If no command handler is set, a UI representation might choose to
     * disable the menu item.
     */
    public void setCommandHandler(Runnable action) {
        commandData.runnable.set(action);
    }

    /**
     * Set the command handler for this menu item and specifies whether the command can be executed. If no command
     * handler is set, a UI representation might choose to disable the menu item.
     */
    public void setCommandHandler(Runnable action, ObservableValue<Boolean> canExecute) {
        commandData.runnable.set(action);
