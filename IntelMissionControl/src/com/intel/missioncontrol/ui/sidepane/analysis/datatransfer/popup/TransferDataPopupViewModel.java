...
public class TransferDataPopupViewModel extends ViewModelBase {
    ...
    private ObjectProperty<Uav> currentUav = new SimpleObjectProperty<>();
    ...
    public TransferDataPopupViewModel(
        ...
        currentUav.bind(PropertyPath.from(currentMissionProperty()).selectReadOnlyObject(Mission::uavProperty));
    ...
    public Uav getCurrentUav() {
        return currentUav.get();
    }

    public ReadOnlyObjectProperty<Uav> currentUavProperty() {
        return currentUav;
    }
                            ...
                            () -> {
                                ...
                                String selectedFolder =
                                    dialogService.showChoicesDialog(
                                        languageHelper.getString(CHOOSE_MATCHING_DIALOG_HEADER),languageHelper.getString(CHOOSE_MATCHING_DIALOG_DOWNLOAD), folders);
