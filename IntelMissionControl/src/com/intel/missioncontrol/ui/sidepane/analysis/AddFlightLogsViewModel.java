...
public class AddFlightLogsViewModel extends DialogViewModel<CopyLogsTask, String> {
    ...
    private final ICommand browseCommand;
    private final ICommand openFolderCommand;
    private final ICommand copySelectedCommand;
    ...
    public ICommand getBrowseCommand() {
        return browseCommand;
    }

    public ICommand getOpenFolderCommand() {
        return openFolderCommand;
    }

    public ICommand getCopySelectedCommand() {
