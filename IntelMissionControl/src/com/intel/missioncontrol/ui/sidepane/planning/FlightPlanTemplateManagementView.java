...
public class FlightPlanTemplateManagementView extends DialogView<FlightPlanTemplateManagementViewModel> {
    ...
    public static final double COL_TEMPLATE_NAME_WIDTH = 1f * Integer.MAX_VALUE * 35; // 35% width
    public static final double COL_UAV_TYPE_WIDTH = 1f * Integer.MAX_VALUE * 15; // 15% width
    public static final double COL_CAMERA_NAME_WIDTH = 1f * Integer.MAX_VALUE * 15; // 15% width
    public static final double COL_LENS_NAME_WIDTH = 1f * Integer.MAX_VALUE * 15; // 15% width
    public static final double COL_AOI_WIDTH = 1f * Integer.MAX_VALUE * 15; // 15% width
    public static final double COL_ACTION_WIDTH = 1f * Integer.MAX_VALUE * 5; // 5% width
    ...
    protected void initializeView() {
            ...
            column ->
                new TableCell<FlightPlanTemplateManagementItem, Button>() {
                    ...
                    protected void updateItem(Button item, boolean empty) {
                        ...
                        getStyleClass().remove("templateRemoveButton");
                        getStyleClass().remove("templateRevertButton");
                        if (rowItem != null) {
                            setText("");
                            if (rowItem.getBuildIn()) {
                                getStyleClass().add("templateRevertButton");
                                setOnMouseClicked(event -> doRevertTemplateAction(getTableRow().getIndex()));
                            } else {
                                getStyleClass().add("templateRemoveButton");
        ...
        action.setMaxWidth(COL_ACTION_WIDTH);
