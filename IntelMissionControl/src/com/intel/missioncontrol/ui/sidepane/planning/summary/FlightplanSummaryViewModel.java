...
public class FlightplanSummaryViewModel extends ViewModelBase {
    ...
    private final IFlightplanChangeListener flightplanChangeListener =
        new IFlightplanChangeListener() {
            ...
            public void flightplanStructureChanged(IFlightplanRelatedObject fp) {
                Platform.runLater(() -> updateRecomputedValues());
            }
    ...
    private final ICommand showEditWayointsDialogCommand;
    ...
    public FlightplanSummaryViewModel(
        ...
        this.recomputeReadyListener =
            (a, b, c) -> {
                Platform.runLater(this::updateRecomputedValues);
            };
        ...
        showEditWayointsDialogCommand =
            new DelegateCommand(
                () -> {
                    ...
                    Futures.addCallback(
                        dialogService.requestDialog(this, EditWaypointsViewModel.class, false),
                        new FutureCallback<>() {
                            @Override
    ...
    public ICommand getShowEditWayointsDialogCommand() {
