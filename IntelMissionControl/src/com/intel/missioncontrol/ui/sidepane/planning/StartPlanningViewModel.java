...
public class StartPlanningViewModel extends ViewModelBase {
    ...
    private final ICommand openAoiScreenCommand;
    private final ICommand showTemplateManagementCommand;
    ...
    public StartPlanningViewModel(
        ...
        renameMissionCommand =
            new com.intel.missioncontrol.ui.commands.DelegateCommand(applicationContext::renameCurrentMission);
    }
    ...
    protected void initializeViewModel() {
        ...
        menuModel
            ...
            .setCommandHandler(this::revertFlightPlanChanges, planningScope.currentFlightplanProperty().isNotNull());
        ...
        menuModel
            ...
            .setCommandHandler(
                ...
                planningScope.currentFlightplanProperty().isNotNull().and(validationService.canExportFlightProperty()));
        menuModel
            .find(MainMenuModel.FlightPlan.AIRMAP_LAANC)
            .visibleProperty()
            .bind(
                generalSettings
                    ...
                    .and(planningScope.currentFlightplanProperty().isNotNull())
                    .and(
                        PropertyPath.from(planningScope.currentFlightplanProperty())
                            .selectReadOnlyBoolean(FlightPlan::saveableProperty))
                    .and(validationService.canExportFlightProperty()));
        ...
        menuModel
            ...
            .setCommandHandler(this::saveFlightPlanAsTemplate, flightPlanSaveable);
        menuModel
            .find(MainMenuModel.FlightPlan.SAVE_AS_TEMPLATE)
            .visibleProperty()
        ...
        menuModel
            ...
            .setCommandHandler(this::updateParentTemplate, planningScope.currentFlightplanProperty().isNotNull());
        menuModel
            .find(MainMenuModel.FlightPlan.UPDATE_PARENT_TEMPLATE)
            .visibleProperty()
            .bind(generalSettings.operationLevelProperty().isEqualTo(OperationLevel.DEBUG));
    ...
    public static void airmapLaancApprove(FlightPlan currentFlightplan, IElevationModel elevationModel) {
        ...
        */
        ...
        try {
            ...
            String qrCode =
                "http://chart.apis.google.com/chart?chs=500x500&cht=qr&chl="
                    + URLEncoder.encode(dynamicLink.toString(), "UTF-8")
                    + "&choe=UTF-8";

            logger.info("deepLink: " + deepLink);
            logger.info("dynamicLink: " + dynamicLink);
            logger.info("qrCode: " + qrCode);
            FileHelper.openFileOrURL(qrCode);
        } catch (Exception e) {
    ...
    public ICommand getOpenAoiScreenCommand() {
        return openAoiScreenCommand;
    }

    public ICommand getShowTemplateManagementCommand() {
    ...
    private void openAoiScreen() {
        ...
        Dispatcher.post(
                () -> {
                    ...
                    mavinciObjectFactory.getOrCreateStartProcedure(newFlightPlan.getLegacyFlightplan());
