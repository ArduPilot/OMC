...
import com.intel.missioncontrol.beans.property.SimpleVariantQuantityProperty;
...
public class EditWaypointsViewModel extends DialogViewModel<Boolean, Void> {
    ...
    private final IParameterizedCommand<SelectionFilter> selectCommand;
    private final IParameterizedCommand<SelectionFilter> deselectCommand;
    private final ICommand invertSelectionCommand;
    private final ICommand deleteSelectedWaypointsCommand;
    private final ICommand applyChangesCommand;
    ...
    public IParameterizedCommand<SelectionFilter> getSelectCommand() {
        return selectCommand;
    }

    public IParameterizedCommand<SelectionFilter> getDeselectCommand() {
        return deselectCommand;
    }

    public ICommand getInvertSelectionCommand() {
        return invertSelectionCommand;
    }

    public ICommand getDeleteSelectedWaypointsCommand() {
        return deleteSelectedWaypointsCommand;
    }

    public ICommand getApplyChangesCommand() {
