...
public class GeneralSettingsSectionViewModel extends ViewModelBase {
    ...
    private final ICommand toggleChooseRefPointCommand;
    ...
    public ICommand getToggleChooseRefPointCommand() {
    ...
    public QuantityProperty<Speed> getMaxGroundSpeedUpperLimitProperty() {
