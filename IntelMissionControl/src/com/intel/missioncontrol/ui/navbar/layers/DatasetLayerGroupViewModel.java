...
public class DatasetLayerGroupViewModel extends LayerGroupViewModel {
    ...
    public DatasetLayerGroupViewModel(
        ...
        Map<String, Function<MatchingViewOptions, BooleanProperty>> items = new ArrayMap<>();
        ...
        for (Map.Entry<String, Function<MatchingViewOptions, BooleanProperty>> entry : items.entrySet()) {
