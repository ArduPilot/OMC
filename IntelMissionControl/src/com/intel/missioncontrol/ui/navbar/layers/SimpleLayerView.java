...
public class SimpleLayerView extends HBox implements JavaView<SimpleLayerViewModel> {
    ...
    void configure(ToggleHint toggleHint, ToggleGroup toggleGroup) {
        ...
        showOnMapButton
            .visibleProperty()
            .bind(this.hoverProperty().and(viewModel.showOnMapCommand().executableProperty()));
        showOnMapButton.managedProperty().bind(showOnMapButton.visibleProperty());
        showOnMapButton.setOnAction(event -> viewModel.showOnMapCommand().execute());
        ...
        deleteButton.visibleProperty().bind(this.hoverProperty().and(viewModel.deleteCommand().executableProperty()));
