...
public class FilesAndFoldersSettingsViewModel extends ViewModelBase {
    ...
    private final IParameterizedCommand<ExternalApplication> browseCommand;
    private final IParameterizedCommand<ExternalApplication> openFolderCommand;
                            ...
                            DialogResult confirmed =
                                dialogService.requestCancelableConfirmation(
                                    languageHelper.getString(
                                        "com.intel.missioncontrol.ui.settings.view.FilesAndFoldersSettingsView.sessionDefaultBaseFolder.title"),
                                    languageHelper.getString(
                                        "com.intel.missioncontrol.ui.settings.view.FilesAndFoldersSettingsView.sessionDefaultBaseFolder.message",
                                        projectFolder.get(),
                                        path.toString()),
                                    new ButtonType[] {
                                        new ButtonType(
                                            languageHelper.getString(
                                                "com.intel.missioncontrol.ui.settings.view.FilesAndFoldersSettingsView.sessionDefaultBaseFolder.yes.button"),
                                            ButtonBar.ButtonData.YES),
                                        new ButtonType(
                                            languageHelper.getString(
                                                "com.intel.missioncontrol.ui.settings.view.FilesAndFoldersSettingsView.sessionDefaultBaseFolder.no.button"),
    ...
    public IParameterizedCommand<ExternalApplication> getBrowseCommand() {
        return browseCommand;
    }

    public IParameterizedCommand<ExternalApplication> getOpenFolderCommand() {
