...
public class AirspacesProvidersSettingsView extends ViewBase<AirspacesProvidersSettingsViewModel> {
    ...
    private void initSpinners() {
        ...
        visualizer.initVisualization(
            viewModel.maxAltitudeAboveGroundValidationStatus(), maxAltitudeAboveGroundErrorLabel);
        ...
        visualizer = new LabelValidationVisualizer();
        visualizer.initVisualization(
            viewModel.maxAltitudeAboveSeaLevelValidationStatus(), maxAltitudeAboveSeaLevelErrorLabel);
        validationVisualizers.add(visualizer);
        ...
        visualizer = new LabelValidationVisualizer();
        visualizer.initVisualization(
            viewModel.minTimeBetweenLandingAndSunsetValidationStatus(), minimumTimeLandingErrorLabel);
        validationVisualizers.add(visualizer);
    }
