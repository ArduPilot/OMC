...
import com.intel.missioncontrol.ui.navbar.tools.model.LinkInfoViewModel;
...
public class LinkInfoView extends ViewBase<LinkInfoViewModel> {

    @InjectViewModel
    private LinkInfoViewModel viewModel;

    @FXML
    private Pane rootNode;

    @FXML
    private TableView<UavDataParameter<LinkInfo>> table;
    ...
    @Override
    public LinkInfoViewModel getViewModel() {
        return viewModel;
    }
