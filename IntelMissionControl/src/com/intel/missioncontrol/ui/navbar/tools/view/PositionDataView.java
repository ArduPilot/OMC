...
import com.intel.missioncontrol.ui.navbar.tools.model.PositionDataViewModel;
...
public class PositionDataView extends ViewBase<PositionDataViewModel> {

    @InjectViewModel
    private PositionDataViewModel viewModel;
    ...
    @Override
    public PositionDataViewModel getViewModel() {
        return viewModel;
    }
