...
public class OtherDetailsViewModel extends AbstractUavDataViewModel<Object> {
    ...
    private ObjectProperty<Uav.StartPositionRaw> startPosition = new SimpleObjectProperty<>();
    private ObjectProperty<Uav.SimulationSettingsRaw> simulationSettings = new SimpleObjectProperty<>();
    ...
    protected void establishUavReferences() {
        ...
        flightPhase.bind(uav.flightPhaseProperty());
        ...
        public StartpositionLonParam() {
            ...
            startPosition.addListener(
                (observable, oldData, newData) ->
                    this.updateValue(Optional.ofNullable(newData).map(Uav.StartPositionRaw::getLon).orElse(null)));
        }
    ...
    private class StartpositionLatParam extends SimpleUavDataParameter<Object> {
        ...
        public StartpositionLatParam() {
            ...
            startPosition.addListener(
                (observable, oldData, newData) ->
                    this.updateValue(Optional.ofNullable(newData).map(Uav.StartPositionRaw::getLat).orElse(null)));
        }
    ...
    private class SimulationSpeedParam extends SimpleUavDataParameter<Object> {
        ...
        public SimulationSpeedParam() {
            ...
            simulationSettings.addListener(
                (observable, oldData, newData) ->
                    this.updateValue(
                        Optional.ofNullable(newData).map(Uav.SimulationSettingsRaw::getSpeed).orElse(null)));
        }
