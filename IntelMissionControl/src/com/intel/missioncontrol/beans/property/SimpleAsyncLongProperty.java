...
public class SimpleAsyncLongProperty extends AsyncLongPropertyBase {

    private final Object bean;
    private String name;

    public SimpleAsyncLongProperty(Object bean) {
        this(bean, new PropertyMetadata.Builder<Number>().create());
    }

    public SimpleAsyncLongProperty(Object bean, PropertyMetadata<Number> metadata) {
        super(metadata);
        this.bean = bean;
