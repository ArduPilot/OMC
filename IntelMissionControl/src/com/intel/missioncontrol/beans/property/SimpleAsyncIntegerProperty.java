...
public class SimpleAsyncIntegerProperty extends AsyncIntegerPropertyBase {

    private final Object bean;
    private String name;

    public SimpleAsyncIntegerProperty(Object bean) {
        this(bean, new PropertyMetadata.Builder<Number>().create());
    }

    public SimpleAsyncIntegerProperty(Object bean, PropertyMetadata<Number> metadata) {
        super(metadata);
        this.bean = bean;
