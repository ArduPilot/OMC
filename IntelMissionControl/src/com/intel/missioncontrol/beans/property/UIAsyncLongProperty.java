...
public class UIAsyncLongProperty extends SimpleAsyncLongProperty implements Property<Number> {

    public UIAsyncLongProperty(Object bean) {
        this(bean, new UIPropertyMetadata.Builder<Number>().create());
    }

    public UIAsyncLongProperty(Object bean, UIPropertyMetadata<Number> metadata) {
        super(bean, metadata);
    }
