...
public class UIAsyncFloatProperty extends SimpleAsyncFloatProperty implements Property<Number> {

    public UIAsyncFloatProperty(Object bean) {
        this(bean, new UIPropertyMetadata.Builder<Number>().create());
    }

    public UIAsyncFloatProperty(Object bean, UIPropertyMetadata<Number> metadata) {
        super(bean, metadata);
    }
