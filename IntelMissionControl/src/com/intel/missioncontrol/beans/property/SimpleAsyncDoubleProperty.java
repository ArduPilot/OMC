...
public class SimpleAsyncDoubleProperty extends AsyncDoublePropertyBase {

    private final Object bean;
    private String name;

    public SimpleAsyncDoubleProperty(Object bean) {
        this(bean, new PropertyMetadata.Builder<Number>().create());
    }

    public SimpleAsyncDoubleProperty(Object bean, PropertyMetadata<Number> metadata) {
        super(metadata);
        this.bean = bean;
