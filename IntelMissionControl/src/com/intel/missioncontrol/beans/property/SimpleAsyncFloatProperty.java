...
public class SimpleAsyncFloatProperty extends AsyncFloatPropertyBase {

    private final Object bean;
    private String name;

    public SimpleAsyncFloatProperty(Object bean) {
        this(bean, new PropertyMetadata.Builder<Number>().create());
    }

    public SimpleAsyncFloatProperty(Object bean, PropertyMetadata<Number> metadata) {
        super(metadata);
        this.bean = bean;
