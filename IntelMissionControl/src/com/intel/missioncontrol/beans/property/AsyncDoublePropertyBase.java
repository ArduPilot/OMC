...
public abstract class AsyncDoublePropertyBase extends AsyncDoubleProperty {
    ...
    public AsyncDoublePropertyBase(PropertyMetadata<Number> metadata) {
        ...
        this.value = initialValue != null ? initialValue.doubleValue() : 0;
    }
    ...
    public final void reset() {
        Number initialValue = metadata.getInitialValue();
        set(initialValue != null ? initialValue.doubleValue() : 0);
    }
    ...
    public void overrideMetadata(PropertyMetadata<Number> metadata) {
        ...
        try {
            ...
            this.value = this.metadata.getInitialValue().doubleValue();
        } finally {
    ...
    private double getUnsynchronized() {
        if (valid) {
            return value;
        }
    ...
    public final String toString() {
        ...
        final StringBuilder result = new StringBuilder("AsyncDoubleProperty [");
        long stamp = 0;
    ...
    private static class Listener implements InvalidationListener, WeakListener {
        ...
        public Listener(AsyncDoublePropertyBase ref, Executor executor) {
