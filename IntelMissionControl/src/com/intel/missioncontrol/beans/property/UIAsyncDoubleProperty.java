...
public class UIAsyncDoubleProperty extends SimpleAsyncDoubleProperty implements Property<Number> {

    public UIAsyncDoubleProperty(Object bean) {
        this(bean, new UIPropertyMetadata.Builder<Number>().create());
    }

    public UIAsyncDoubleProperty(Object bean, UIPropertyMetadata<Number> metadata) {
        super(bean, metadata);
    }
