...
public class SimpleAsyncStringProperty extends AsyncStringPropertyBase {

    private final Object bean;
    private String name;

    public SimpleAsyncStringProperty(Object bean) {
        this(bean, new PropertyMetadata.Builder<String>().create());
    }

    public SimpleAsyncStringProperty(Object bean, PropertyMetadata<String> metadata) {
        super(metadata);
        this.bean = bean;
