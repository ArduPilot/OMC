...
public abstract class AsyncLongPropertyBase extends AsyncLongProperty {
    ...
    public AsyncLongPropertyBase(PropertyMetadata<Number> metadata) {
        ...
        this.value = initialValue != null ? initialValue.longValue() : 0;
    }
    ...
    public final void reset() {
        Number initialValue = metadata.getInitialValue();
        set(initialValue != null ? initialValue.longValue() : 0);
    }
    ...
    public void overrideMetadata(PropertyMetadata<Number> metadata) {
        ...
        try {
            ...
            this.value = this.metadata.getInitialValue().longValue();
        } finally {
    ...
    private long getUnsynchronized() {
        if (valid) {
            return value;
        }
    ...
    public final String toString() {
        ...
        final StringBuilder result = new StringBuilder("AsyncLongProperty [");
        long stamp = 0;
    ...
    private static class Listener implements InvalidationListener, WeakListener {
        ...
        public Listener(AsyncLongPropertyBase ref, Executor executor) {
