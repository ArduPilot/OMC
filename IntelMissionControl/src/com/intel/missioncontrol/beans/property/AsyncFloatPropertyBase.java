...
public abstract class AsyncFloatPropertyBase extends AsyncFloatProperty {
    ...
    public AsyncFloatPropertyBase(PropertyMetadata<Number> metadata) {
        ...
        this.value = initialValue != null ? initialValue.floatValue() : 0;
    }
    ...
    public final void reset() {
        Number initialValue = metadata.getInitialValue();
        set(initialValue != null ? initialValue.floatValue() : 0);
    }
    ...
    public void overrideMetadata(PropertyMetadata<Number> metadata) {
        ...
        try {
            ...
            this.value = this.metadata.getInitialValue().floatValue();
        } finally {
    ...
    private float getUnsynchronized() {
        if (valid) {
            return value;
        }
    ...
    public final String toString() {
        ...
        final StringBuilder result = new StringBuilder("AsyncFloatProperty [");
        long stamp = 0;
    ...
    private static class Listener implements InvalidationListener, WeakListener {
        ...
        public Listener(AsyncFloatPropertyBase ref, Executor executor) {
