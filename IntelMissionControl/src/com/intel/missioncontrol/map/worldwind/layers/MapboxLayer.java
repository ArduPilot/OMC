...
public class MapboxLayer extends FastMercatorTiledImageLayer {
    ...
    /*public static class Keys {
        static final String defMapID_pureSat = "intel-imc-insight/cjepc0kfse3ru2smoozmhtir1";
        public static final String defAccessToken =
            "pk.eyJ1IjoiaW50ZWwtaW1jLWluc2lnaHQiLCJhIjoiY2plcGJ2ejlvMGN1YjJ3bzlvb2MzaTJsdyJ9.fqEzRMiXHrkszC7QkhMHuA";

        static final String defMapID_hybrid = "intel-imc-insight/cjepc082r16772rp2t1body7q";
        static final String defAccessTokenHybrid =
            "pk.eyJ1IjoiaW50ZWwtaW1jLWluc2lnaHQiLCJhIjoiY2plcGJ2ejlvMGN1YjJ3bzlvb2MzaTJsdyJ9.fqEzRMiXHrkszC7QkhMHuA";

        static final String defMapID_pureStreets = "intel-imc-insight/cjghm3yt4003b2so9gf8gas3y";
    ...
    public static final class Streets extends WWLayerWrapper {
        ...
        public Streets(
                ...
                WWLayerSettings mapSettings) {
            super(
                    new MapboxLayer(
                            MapType.STREETS,
                            new Options(pathProvider.getCacheDirectory().resolve("mapbox2").toFile(), networkInterceptor),
                            mapSettings.mapboxMapIdStreetsProperty().get(),
                            mapSettings.mapboxAccessTokenProperty().get()),
                    syncRoot);
        }
    }
        ...
        public Satellite(
            ...
            super(
                    new MapboxLayer(
                            MapType.SATELLITE,
                            new Options(pathProvider.getCacheDirectory().resolve("mapbox2").toFile(), networkInterceptor),
                            mapSettings.mapboxMapIdSatProperty().get(),
                            mapSettings.mapboxAccessTokenProperty().get()),
                    syncRoot);
        }
    }
        ...
        public Hybrid(
            ...
            super(
                    new MapboxLayer(
                            MapType.HYBRID,
                            new Options(pathProvider.getCacheDirectory().resolve("mapbox2").toFile(), networkInterceptor),
                            mapSettings.mapboxMapIdHybridProperty().get(),
                            mapSettings.mapboxAccessTokenProperty().get()),
                    syncRoot);
        }
    }
    ...
    public MapboxLayer(MapType type, Options options, String mapID, String accessToken) {
        super(
                makeLevels(options.useLargeTiles, mapID, accessToken),
