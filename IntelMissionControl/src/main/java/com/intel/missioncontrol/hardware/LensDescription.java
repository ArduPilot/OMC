...
class LensDescription extends NotificationObject implements IMutableLensDescription {
    ...
    public static class Deserializer implements JsonDeserializer<LensDescription> {
        ...
        public LensDescription deserialize(JsonElement arg0, Type arg1, JsonDeserializationContext context)
            ...
            description.setIsLensApertureNotAvailable(helper.getBoolean("isApertureNotAvailable"));
            return description;
        }
    }
    ...
    private boolean isLensApertureNotAvailable;
    ...
    @Override
    public boolean isLensApertureNotAvailable() {
        return isLensApertureNotAvailable;
    }

    @Override
    public void setIsLensApertureNotAvailable(boolean isLensApertureNotAvailable) {
        if (this.isLensApertureNotAvailable!= isLensApertureNotAvailable) {
            boolean oldValue = this.isLensApertureNotAvailable;
            this.isLensApertureNotAvailable = isLensApertureNotAvailable;
            notifyPropertyChanged(IS_LENS_APERTURE_NOT_AVAILABLE_PROPERTY, oldValue, isLensApertureNotAvailable);
        }
    }
