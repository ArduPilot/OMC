...
public interface IMutablePayloadDescription extends IPayloadDescription {
    ...
    void setEnforcePitchRange(boolean value);

    void setIsExposureTimeFixed(boolean value);
