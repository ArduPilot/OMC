...
public abstract class MavlinkDrone implements IDrone {
    ...
    MavlinkDrone(IMavlinkDroneConnection droneConnection, IPlatformDescription platformDescription) {
    ...
    void initializeBindings() {
        double linkLostTimeoutSeconds = platformDescription.get().getConnectionProperties().getLinkLostTimeoutSeconds();
    ...
    protected RemoteControl getRemoteControl() {
        return remoteControl.get();
    }
    ...
    protected void raiseDroneConnectionExceptionEvent(DroneConnectionException e) {
    ...
    void raiseDroneMessageEvent(DroneMessage message) {
    ...
    IMavlinkDroneConnection getDroneConnection() {
        ...
        return Dispatcher.platform()
            ...
            .thenApplyAsync(
                autopilotParameterList -> {
                    ...
                    return getDroneConnection().getParameterProtocolSender().setParamsAsync(autopilotParameterList);
                });
    }
    ...
    /** Set the given Flightplan as active and upload. */
    @Override
    public Future<Void> setActiveFlightPlanAsync(FlightPlanWithWayPointIndex flightPlanWithWayPointIndex) {
        // TODO post
        ...
        final IMavlinkFlightPlanOptions mavlinkFlightPlanOptions =
            platformDescription.get().getMavlinkFlightPlanOptions();
