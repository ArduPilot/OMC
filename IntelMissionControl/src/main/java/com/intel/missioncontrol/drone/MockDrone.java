...
public class MockDrone implements IDrone {
    ...
    private final AsyncObjectProperty<IHardwareConfiguration> hardwareConfiguration = new SimpleAsyncObjectProperty<>(this);
    ...
    private final AsyncObjectProperty<IObstacleAvoidance> obstacleAvoidance =
    ...
    public MockDrone(IHardwareConfiguration hardwareConfiguration) {
        ...
        obstacleAvoidance.set(new IObstacleAvoidance() {
            @Override
            ...
            public ReadOnlyAsyncObjectProperty<Mode> modeProperty() {
                AsyncObjectProperty<Mode> mode = new SimpleAsyncObjectProperty<>(
                        this, new PropertyMetadata.Builder<Mode>().initialValue(Mode.ENABLED).create());
                return mode;
            }
