...
import org.asyncfx.beans.property.ReadOnlyAsyncListWrapper;
...
public class GeneralSettings implements ISettings, IQuantityStyleProvider {
    ...
    private AsyncObjectProperty<Theme> theme =
        new SimpleAsyncObjectProperty<>(this, new PropertyMetadata.Builder<Theme>().initialValue(Theme.MOUSE).create());
