...
public class CopyLogsTask extends IBackgroundTaskManager.BackgroundTask {
    ...
    public CopyLogsTask(
        ...
        this.mission = applicationContext.getCurrentLegacyMission();
    ...
    protected Void call() throws Exception {
        File ftpFolder =
            MissionConstants.getFlightLogsFolder(applicationContext.getCurrentLegacyMission().getDirectoryFile());
        int i = 0;
