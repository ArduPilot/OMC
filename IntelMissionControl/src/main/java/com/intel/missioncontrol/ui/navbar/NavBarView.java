        ...
        workflowToggleGroup
            ...
            .addListener(
                (observable, oldValue, newValue) -> {
                    if (newValue != null) {
                        viewModel.getNavigateToCommand().execute((WorkflowStep)newValue.getUserData());
                    }
                });
            ...
            .addListener(
                (observable, oldValue, newValue) -> {
                    if (newValue != null) {
                        ...
                        viewModel.getNavigateToCommand().execute(navbarDialog);
                    } else {
                        viewModel.getNavigateToCommand().execute(NavBarDialog.NONE);
                    }
                });
        ...
        layoutRoot.addEventHandler(
            ...
            event -> {
                if (event.getCode() == KeyCode.ESCAPE) {
                    getViewModel().getNavigateToCommand().execute(NavBarDialog.NONE);
                }
            });
    }
