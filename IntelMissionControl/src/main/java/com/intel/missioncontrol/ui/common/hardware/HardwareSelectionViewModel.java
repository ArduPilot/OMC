...
public class HardwareSelectionViewModel extends ViewModelBase {
    ...
    @SuppressLinter(value = "IllegalViewModelMethod", reviewer = "mstrauss", justification = "legacy code")
    ...
    private void selectPlatformItem(@NotNull IPlatformDescription description) {
