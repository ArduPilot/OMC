...
public class LayerGroupView extends TitledPane implements JavaView<LayerGroupViewModel> {
    ...
    public void initialize() {
        ...
        settingsButton.visibleProperty().bind(viewModel.getOpenSettingsCommand().executableProperty());
        settingsButton.managedProperty().bind(viewModel.getOpenSettingsCommand().executableProperty());
        settingsButton.setOnAction(event -> viewModel.getOpenSettingsCommand().execute());
        ...
        deleteButton.visibleProperty().bind(viewModel.getDeleteCommand().executableProperty());
        deleteButton.managedProperty().bind(viewModel.getDeleteCommand().executableProperty());
        deleteButton.setOnAction(event -> viewModel.getDeleteCommand().execute());

        Button warning = new Button();
        warning.getStyleClass().add("icon-warning");
        ...
        warning.setOnAction(event -> viewModel.getResolveWarningCommand().execute());
