...
public class MainViewModel extends DialogViewModel<Void, Void> {
    ...
    public Command getDeleteSelectionCommand() {
    ...
    public ParameterizedCommand<Object> getMapActionCommand() {
        return mapActionCommand;
    }

    public ParameterizedAsyncCommand<Point2D> getShowWarningsCommand() {
        return showWarningsCommand;
    }

    public ParameterizedAsyncCommand<Point2D> getShowBackgroundTasksCommand() {
    ...
    public Command getReloadStylesheetsCommand() {
    ...
    protected void initializeViewModel() {
        ...
        applicationContext.currentLegacyMissionProperty().addListener(this::currentMissionChanged);
    ...
    private String createWindowTitle(@Nullable String missionName) {
        String title = "Intel Mission Control " + ManifestInfo.getVersion();
