...
public class AoiTransformationTabViewModel extends ViewModelBase<AreaOfInterest> {
    ...
    private ParameterizedCommand<Pair<CPicArea.ModelAxis, CPicArea.ModelAxis>> deleteCommand;
    ...
    public ParameterizedCommand<Pair<CPicArea.ModelAxis, CPicArea.ModelAxis>> getDeleteCommand() {
