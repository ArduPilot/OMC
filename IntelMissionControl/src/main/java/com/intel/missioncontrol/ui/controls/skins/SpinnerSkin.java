...
public class SpinnerSkin<T> extends SkinBase<Spinner<T>> {
    ...
    /**
     * Creates a new SpinnerSkin instance, installing the necessary child nodes into the Control {@link
     * Control#getChildren() children} list, as well as the necessary input mappings for handling key, mouse, etc
     * events.
     *
