...
public class RadiusHeightWidgetView extends VBox implements Initializable, FxmlView<RadiusHeightWidgetViewModel> {
    ...
    @FXML
    public Label spinnerHeightLabel;

    @FXML
    public Label spinnerRadiusLabel;
    ...
    @InjectViewModel
    private RadiusHeightWidgetViewModel viewModel;
