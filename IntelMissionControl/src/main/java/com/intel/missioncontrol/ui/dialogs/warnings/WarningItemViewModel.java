...
class WarningItemViewModel implements ViewModel {
    ...
    private Command firstResolveActionCommand;
    private Command secondResolveActionCommand;
    ...
    public Command getFirstResolveActionCommand() {
        return firstResolveActionCommand;
    }

    public Command getSecondResolveActionCommand() {
