...
public class MainMenuModel {
            ...
            MenuModel.menu(
                ...
                MenuModel.group(
                    MenuModel.item(
                        ...
                        languageHelper.toFriendlyName(Help.SUPPORT_REQUEST),
                        languageHelper.toFriendlyName(HelpText.SUPPORT_REQUEST),
                        Help.SUPPORT_REQUEST.getIcon(),
    ...
    public enum Project implements Localizable {
        MENU_CAPTION,
        NEW,
        OPEN,
        CLOSE,
    ...
    private enum ProjectText implements Localizable {
        NEW,
        OPEN,
        CLOSE,
        RENAME,
    ...
    public enum FlightPlan implements Localizable {
        MENU_CAPTION,
        NEW,
        OPEN,
        CLOSE,
    ...
    private enum FlightPlanText implements Localizable {
        NEW,
        OPEN,
        CLOSE,
        SAVE,
    ...
    public enum Dataset implements Localizable {
        MENU_CAPTION,
        NEW,
        OPEN,
        CLOSE,
    ...
    private enum DatasetText implements Localizable {
        NEW,
        OPEN,
        CLOSE,
        SAVE,
    ...
    public enum Help implements Localizable {
        MENU_CAPTION,
        USER_MANUAL,
        QUICK_START_GUIDE,
        SUPPORT_REQUEST,
    ...
    private enum HelpText implements Localizable {
        USER_MANUAL,
        QUICK_START_GUIDE,
        SUPPORT_REQUEST,
        UPLOAD_OLD_SUPPORT_REQUESTS,
        DOWNLOAD_TICKET,
        DEMO_MISSION,
        ABOUT
    }

    public enum Debug implements Localizable {
        MENU_CAPTION,
        RELOAD_CSS,
        REPORT_DIAGNOSTICS,
        BREAK_AFTER,
