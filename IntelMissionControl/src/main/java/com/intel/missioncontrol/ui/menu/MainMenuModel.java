        ...
        return MenuModel.build(
            ...
            MenuModel.menu(
                ...
                MenuModel.group(
                    ...
                    MenuModel.item(
                        Help.UPLOAD_OLD_SUPPORT_REQUESTS,
                        languageHelper.toFriendlyName(Help.UPLOAD_OLD_SUPPORT_REQUESTS),
                        languageHelper.toFriendlyName(HelpText.UPLOAD_OLD_SUPPORT_REQUESTS)),
                    MenuModel.item(
                        Help.DOWNLOAD_TICKET,
                        languageHelper.toFriendlyName(Help.DOWNLOAD_TICKET),
                        languageHelper.toFriendlyName(HelpText.DOWNLOAD_TICKET))),
                MenuModel.item(
                    Help.ABOUT,
