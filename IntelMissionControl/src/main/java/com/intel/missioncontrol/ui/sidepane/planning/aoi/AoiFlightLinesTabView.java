...
public class AoiFlightLinesTabView extends ViewBase<AoiFlightLinesTabViewModel> {
    ...
    public void initializeView() {
        ...
        ViewHelper.initAutoCommitSpinner(
            ...
            viewModel.maxYawRollChangeProperty(),
            Unit.DEGREE,
        ...
        ViewHelper.initAutoCommitSpinner(
            ...
            viewModel.maxPitchChangeProperty(),
            Unit.DEGREE,
            settingsManager.getSection(GeneralSettings.class),
            0,
            CAMERA_MAX_ANGLE_CHANGE_MIN,
        ...
        ViewHelper.initAutoCommitSpinner(
            ...
            viewModel.cameraPitchOffsetProperty(),
            Unit.DEGREE,
            settingsManager.getSection(GeneralSettings.class),
            0,
        ...
        ViewHelper.initAutoCommitSpinner(
            ...
            viewModel.cameraRollOffsetProperty(),
            Unit.DEGREE,
            settingsManager.getSection(GeneralSettings.class),
            0,
        ...
        ViewHelper.initAutoCommitSpinner(
            ...
            viewModel.overlapInFlightProperty(),
            Unit.PERCENTAGE,
            settingsManager.getSection(GeneralSettings.class),
            0,
            PERCENT_MIN,
        ...
        ViewHelper.initAutoCommitSpinner(
            ...
            viewModel.overlapInFlightMinProperty(),
            Unit.PERCENTAGE,
            settingsManager.getSection(GeneralSettings.class),
            0,
            PERCENT_MIN,
        ...
        ViewHelper.initAutoCommitSpinner(
            ...
            viewModel.overlapParallelProperty(),
            Unit.PERCENTAGE,
            settingsManager.getSection(GeneralSettings.class),
            0,
            PERCENT_MIN,
        ...
        ViewHelper.initAutoCommitSpinner(
            ...
            viewModel.cameraPitchOffsetLineBeginProperty(),
            Unit.DEGREE,
            settingsManager.getSection(GeneralSettings.class),
            0,
            -90.,
        ...
        ViewHelper.initAutoCommitSpinner(
            ...
            viewModel.minObjectDistanceProperty(),
            Unit.METER,
            settingsManager.getSection(GeneralSettings.class),
            1,
            OBJ_DISTANCE_MIN,
        ...
        ViewHelper.initAutoCommitSpinner(
            ...
            viewModel.maxObjectDistanceProperty(),
            Unit.METER,
            settingsManager.getSection(GeneralSettings.class),
            1,
            OBJ_DISTANCE_MIN,
        ...
        ViewHelper.initAutoCommitSpinner(
            ...
            viewModel.minGroundDistanceProperty(),
            Unit.METER,
            settingsManager.getSection(GeneralSettings.class),
            1,
            OBJ_DISTANCE_MIN,
