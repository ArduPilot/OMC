...
public class TelemetryListView extends ViewBase<TelemetryListViewModel> {
    ...
    protected void initializeView() {
        ...
        viewModel.batteryAlertLevelProperty().addListener((observable, oldValue, newValue) -> updateBatteryStyle());
    ...
    private void updateBatteryStyle() {
        BatteryAlertLevel alertLevel = viewModel.batteryAlertLevelProperty().getValue();
