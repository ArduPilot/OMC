...
public class TelemetryView extends ViewBase<TelemetryViewModel> {
    ...
    protected void initializeView() {
        ...
        viewModel // TODO listen to oa distance telem from drone instead
            .batteryRemainingChargeProperty()
            .addListener((observable, oldValue, newValue) -> updateOaDistanceStyle());
    }
    ...
    private void updateOaDistanceStyle() {
        ...
        if (oaAlertLevel == null) {
            oaAlertLevel = DistanceSensor.AlertLevel.UNKNOWN;
        }
        ...
        oaDistanceButton
            .getStyleClass()
            .removeAll("icon-oa-3", "icon-oa-2", "icon-oa-1", "icon-oa-0", "prewarn", "critical");
