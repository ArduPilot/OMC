...
public class WWWidgetMouseAdapter extends MouseAdapter {
    ...
    public void mouseClicked(MouseEvent mouseEvent) {
        ...
        actOnWWMouseEvent(mouseEvent, ray);
    }

    public void actOnWWMouseEvent(MouseEvent mouseEvent, Line ray) {
        if (!Platform.isFxApplicationThread()) {
            Dispatcher.platform().runLater(() -> actOnWWMouseEvent(mouseEvent, ray));
            return;
        }
        ...
        case ADD_POINTS:
            ...
            if (lastAlt == Float.NEGATIVE_INFINITY
                ...
                mapModel.addNodeFromGui(pFinal.getLatitude().degrees, pFinal.getLongitude().degrees);
                mouseEvent.consume();
                return;
            }
        ...
        case SET_SIMULATION_TAKEOFF:
            ...
            } else if (tmp instanceof LandingPoint) {
                LandingPoint origin = (LandingPoint)tmp;
                origin.setLatLon(p.getLatitude().degrees, p.getLongitude().degrees);
            }
