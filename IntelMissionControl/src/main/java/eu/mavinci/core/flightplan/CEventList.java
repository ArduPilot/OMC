...
public abstract class CEventList extends AFlightplanContainer implements IMuteable, IRecalculateable {
    ...
    public double getSafetyAltitudeMeter() {
        return getAltWithinM() ;
    }
    public boolean setSafetyAltitudeMeter(double safetyAltitudeMeter) {
        if (getAltWithinM() == safetyAltitudeMeter) {
            return false;
        }

        flightplanStatementChanged(this);
        this.setAltWithinM(safetyAltitudeMeter);
        return true;
    }
    ...
    @Deprecated
    public static final int minSafetyAlt_CM = 2000;
    ...
    public static final String NAME_GPSLOSS = "gpsloss"; //gnssLinkLoss
    public static final String NAME_RCDATALOSS = "rcdataloss"; //geofenceBreach
    public static final String NAME_RCLOSS = "rcloss"; //rcLinkLoss
    public static final String NAME_DATALOSS = "dataloss"; //primaryLinkLoss
    ...
    public boolean doSubRecalculationStage1() {
        if (getFlightplan().getLandingpoint().isLandAutomatically()) {
            return true;
        }
