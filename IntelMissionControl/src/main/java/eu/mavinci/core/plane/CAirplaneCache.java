...
public class CAirplaneCache implements IAirplaneListenerAllExternal, IAirplaneListenerConnectionState {
    ...
    public synchronized void recv_health(HealthData d) {
        ...
        if (healthChannelMainBattery >= 0 && lastHealthLowpassBat != d) {
            ...
            // System.out.println("Battery raw:" +d.absolute.get(healthChannelMainBattery) + "  " +
            // d.percent.get(healthChannelMainBattery));
            ...
            // TODO: Is this necessary. I commented this because it is not giving instantaneous values and is updating
            // the battery values with avergae values.
            ...
            // System.out.println("Battery avg:" +d.absolute.get(healthChannelMainBattery) + "  " +
            // d.percent.get(healthChannelMainBattery));
        }
        ...
        if (healthChannelFailevents >= 0) {
            ...
            case 5:
                action = AirplaneEventActions.positionHoldCopter;
                break;
            case 6:
            ...
            case 7:
                ...
                break;
            case 8:
                action = AirplaneEventActions.warnCopter;
                break;
            case 9:
