...
public class Licence extends MProperties {
    ...
    public static final String KEY_GRAYHAWKEDITION = "GRAYHAWKEDITION";
    ...
    private boolean isGreyHawkEdition;
    ...
    public List<String> getEditionList() {
        ...
        if (this.isInternalGui() || getMaxOperationLevel().compareTo(OperationLevel.DEBUG) >= 0) {
            ...
            if (isGrayHawkEdition()) {
                editions.add("GrayHawk");
            }
        }
    ...
    public boolean isFalconEdition() {
        if (!isFalconEdition) {
            return !isDJIEdition() && !isGrayHawkEdition();
        }
    ...
    public void setIsGrayHawkEdition(boolean isGrayHawkEdition) {
        this.isGreyHawkEdition = isGrayHawkEdition;
    }

    public boolean isGrayHawkEdition() {
        return isGreyHawkEdition;
    }
    ...
    public void toXML(File file) throws FileNotFoundException, UnsupportedEncodingException {
        // TODO add FalconEdition and DJIEdition and Gray Hawk
