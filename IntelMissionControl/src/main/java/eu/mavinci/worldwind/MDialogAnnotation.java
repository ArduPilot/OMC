...
/** @author Sergio */
public abstract class MDialogAnnotation extends GlobeAnnotation implements java.awt.event.ActionListener {
    ...
    protected MDialogAnnotation(Position position) {
        super("", position);
        this.initComponents();
    ...
    protected void setupContainer(Annotation annotation) {
        ...
        defaultAttribs.setBackgroundColor(new Color(37, 37, 37, 0));
        this.setupDefaultAttributes(defaultAttribs);
        defaultAttribs.setAdjustWidthToText(AVKey.SIZE_FIT_TEXT);
        defaultAttribs.setSize(new java.awt.Dimension(100, 0));
    ...
    protected void setupLabel(Annotation annotation) {
        AnnotationAttributes defaultAttribs = new AnnotationAttributes();
        this.setupDefaultAttributes(defaultAttribs);
        defaultAttribs.setAdjustWidthToText(AVKey.AVERAGE_TILE_SIZE);
        defaultAttribs.setSize(new java.awt.Dimension(100, 0));
    ...
    protected void setupDefaultAttributes(AnnotationAttributes attributes) {
        java.awt.Color transparentBlack = new java.awt.Color(37, 37, 37, 80);
    ...
    protected static class BusyImage extends ImageAnnotation {
        ...
        protected void transformBackgroundImageCoordsToAnnotationCoords(
            ...
            // Rotate around an axis originating from the center of the image
            // and coming out of the screen.
