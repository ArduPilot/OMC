...
public class Flightplan extends CFlightplan implements ISectorReferenced, IResourceFileReferenced {
    ...
    private SectorVisitor secVis = null;
    private FPsim fpSim;
    ...
    private void saveAs(File baseFolder) {
    ...
    public boolean doSubRecalculationStage1() {
        ...
        return getHardwareConfiguration().hasPrimaryPayload(IGenericCameraConfiguration.class);
    }
    ...
    public static class CollisionCheckResult {
        public ConnectingFlightLine connectingFlightLine;
        public Collection<PicArea> picAreas;
    }

    public CollisionCheckResult firstCollisionLineWithAOI(Position start, Position end, Vector<PicArea> picAreas) {
        // TODO jan, use this for computing collisions with other object in FP
        ...
        if (!geoFences.isEmpty()) {
            ...
            if (!foundFence) {
                ...
                res.connectingFlightLine = connectingFlightLine;
                return res;
            }
        }

        CollisionCheckResult res = new CollisionCheckResult();
        res.picAreas = collisions;
        res.connectingFlightLine = connectingFlightLine;
        return res;
    }
    ...
    public boolean doFlightplanCalculation() {
        ...
        try {
            ...
            if (getHardwareConfiguration().getPlatformDescription().isInCopterMode()) {
                ...
                fpPostProcessor.addPhantomWaypointsLitchi();
            }
    ...
    public static class ConnectingFlightLine {
        ...
        public final IFlightplanPositionReferenced endPoint; // ending point of line

        public final Position startPos; // starting point of line
        public final Position endPos; // ending point of line

        public final IFlightplanContainer startContainer; // picArea of starting waypoint
