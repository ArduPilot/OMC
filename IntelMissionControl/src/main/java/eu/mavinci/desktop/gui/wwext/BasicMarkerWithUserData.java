...
public class BasicMarkerWithUserData extends BasicMarker implements IWWRenderableWithUserData {

    public BasicMarkerWithUserData(Position position, MarkerAttributes attrs, Angle heading) {
        super(position, attrs, heading);
    }

    public BasicMarkerWithUserData(Position position, MarkerAttributes attrs) {
