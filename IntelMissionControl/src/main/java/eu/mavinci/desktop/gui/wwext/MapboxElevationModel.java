...
public class MapboxElevationModel extends BasicElevationModel {
    ...
    public MapboxElevationModel(Element domElement, AVList params) {
        super(createDefaultAVListParams(domElement));
     ...
     * @return
     */
    public static AVList createDefaultAVListParams(Element domElement) {
    ...
    public void createTopLevelTiles() {
        ...
        for (int row = firstRow; row <= lastRow; row++) {
            ...
            for (int col = firstCol; col <= lastCol; col++) {
                ...
                this.topLevels.add(new MercatorElevationTile(new MercatorSector(d1, d2, t1, t2), level, row, col));
                t1 = t2;
            }
    ...
    public ElevationTile createTile(TileKey key) {
        ...
        return new MercatorElevationTile(new MercatorSector(d1, d2, t1, t2), level, row, col);
    }
    ...
    public class MercatorElevationTile extends ElevationTile {
        ...
        public MercatorElevationTile(MercatorSector mercatorSector, Level level, int row, int column) {
        ...
        public MercatorElevationTile[] createSubTiles(Level nextLevel) {
            ...
            if (subTile != null) subTiles[0] = subTile;
                ...
                subTiles[0] =
                    new MercatorElevationTile(new MercatorSector(d0, d1, t0, t1), nextLevel, 2 * row, 2 * col);
            ...
            if (subTile != null) subTiles[1] = subTile;
                ...
                subTiles[1] =
                    new MercatorElevationTile(new MercatorSector(d0, d1, t1, t2), nextLevel, 2 * row, 2 * col + 1);
            ...
            if (subTile != null) subTiles[2] = subTile;
                ...
                subTiles[2] =
                    new MercatorElevationTile(new MercatorSector(d1, d2, t0, t1), nextLevel, 2 * row + 1, 2 * col);
            ...
            if (subTile != null) subTiles[3] = subTile;
                ...
                subTiles[3] =
                    new MercatorElevationTile(new MercatorSector(d1, d2, t1, t2), nextLevel, 2 * row + 1, 2 * col + 1);
    ...
    protected static class URLBuilder implements TileUrlBuilder {
        public URL getURL(Tile tile, String altImageFormat) {
            return MapboxElevationModel.tileToUrl(tile);
        }
    }

    // copied from MapboxLayer
    private static URL tileToUrl(Tile tile) {
        ...
        String link =
            "https://api.mapbox.com/v4/mapbox.terrain-rgb/"
                ...
                + "@2x"
                + ".pngraw?access_token="
                + MapboxLayer.Keys.defAccessToken;
     ...
     * @return
     */
    public Elevations getElevations(Sector requestedSector, LevelSet levelSet, int targetLevelNumber) {
    ...
    public BufferWrapper readElevations(URL url, Tile tile) throws Exception {
        try (InputStream tmpStream = url.openStream();
            ...
            AVList bufferParams = createDefaultAVListParams(null);
