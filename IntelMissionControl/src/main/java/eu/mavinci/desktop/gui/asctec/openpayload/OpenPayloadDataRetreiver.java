                ...
                public void run() {
                    ...
                    try {
                        ...
                        while (true) {
                            ...
                            try {
                                ...
                                Debug.getLog()
                                    .log(
                                        Level.SEVERE,
                                        "Could not read from openPayload broadcast listener socket. close connectionDialog",
                                        e);
                                dsocket.close();
                                isBroadcastListening = false;
                                return;
                        ...
                        Debug.getLog()
                            .log(
                                Level.SEVERE,
                                "Could not read from Backend broadcast listener socket. close connectionDialog",
                                t);
                        isBroadcastListening = false;
                    } finally {
                        if (dsocket != null) {
