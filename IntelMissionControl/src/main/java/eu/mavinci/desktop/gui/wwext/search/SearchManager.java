...
public class SearchManager implements ISectorReferenced, IKeepAll {
    ...
    private final Gazetteer gazetteer = CombinedGazetteer.createAllGazeteer();
    ...
    @Inject
    public SearchManager(IWWGlobes globes, ILanguageHelper languageHelper, ISelectionManager selectionManager) {
        this.globes = globes;
    ...
    public synchronized void search(String input) {
        ...
        try {
            ...
            if (latLon != null) {
                ...
                Dispatcher.platform().runLater(this::fireResultChanged);
                return;
            }
        } catch (Exception e) {
