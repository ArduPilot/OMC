...
public class HereAutoCompleteGazetteer implements Gazetteer, IReaderFromCache {
    ...
    public static final String HERE_APP_ID = "TODOid";
    public static final String HERE_APP_CODE = "TODOcode";
    private ArrayList<PointOfInterest> result = new ArrayList<PointOfInterest>();

    public HereAutoCompleteGazetteer() {
        url = URL_HERE;
    }

    public HereAutoCompleteGazetteer(String url) {
        this.url = url;
    }
