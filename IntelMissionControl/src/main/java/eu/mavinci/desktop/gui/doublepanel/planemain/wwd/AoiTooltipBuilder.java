...
public class AoiTooltipBuilder {
    ...
    private void initTooltipBuilders() {
        ...
        tooltipBuilders.put(PlanType.INSPECTION_POINTS, this::appendInspectionPointsText);
    ...
    private void appendInspectionPointsText(PicArea picArea, StringBuilder builder) {
        appendTitle(picArea, builder);
        appendHeight(picArea, builder);
    }
