    ...
    public void getAllControllersInfo() {
        ...
        for (int i = 0; i < controllersList.length; i++) {
            ...
            for (int j = 0; j < components.length; j++) {
                ...
                if (components[j].isRelative()) System.out.print("Relative");
                else System.out.print("Absolute");

                if (components[j].isAnalog()) System.out.print(" Analog");
                else System.out.print(" Digital");
            }
