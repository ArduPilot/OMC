...
public enum MissionItemType {
    ...
    START_IMAGE_CAPTURE("Start Image Capture") {
        @Override
        public MissionItem getNewItem() {
            return new StartImageCapture();
        }

        @Override
        protected Creator<StartImageCapture> getMissionItemCreator() {
            return StartImageCapture.CREATOR;
        }
    ...
    MOUNT_CONTROL("Mount Control") {
        @Override
        public MissionItem getNewItem() {
            return new MountControl();
        }

        @Override
        protected Creator<MountControl> getMissionItemCreator() {
            return MountControl.CREATOR;
        }
