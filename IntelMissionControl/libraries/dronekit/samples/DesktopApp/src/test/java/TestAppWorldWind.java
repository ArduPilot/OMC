...
public class TestAppWorldWind extends ApplicationTemplate {
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        protected void initialize(boolean includeStatusBar, boolean includeLayerPanel, boolean includeStatsPanel) {
            super.initialize(includeStatusBar, includeLayerPanel, includeStatsPanel);
        }
    ...
    public static void main(String[] args)
    {
        ...
        ApplicationTemplate.start("WorldWind Paths With Direction", TestAppWorldWind.AppFrame.class);
    }
}
