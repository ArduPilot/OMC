...
public class MockingHelper {
    ...
    public static ISettingsManager createSettingManagerMock() {
        ...
        when(settingsManager.getSection(AirTrafficMonitorSettings.class)).thenReturn(new AirTrafficMonitorSettings());
        when(settingsManager.getSection(RtkBasePositionsSettings.class)).thenReturn(new RtkBasePositionsSettings());
        ...
        when(settingsManager.getSection(NtripConnections.class)).thenReturn(new NtripConnections());
        when(settingsManager.getSection(RtkSettings.class)).thenReturn(RtkSettings.createDefault());
