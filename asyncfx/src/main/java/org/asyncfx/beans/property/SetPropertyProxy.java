...
class SetPropertyProxy<E> extends SetProperty<E> {
    ...
    private SetProperty<E> peer;
    private ReadOnlyIntegerWrapper size;
    private ReadOnlyBooleanWrapper empty;

    SetPropertyProxy(PropertyPath.PropertyPathSegment endpoint, ObservableSet<E> fallbackValue) {
        this.endpoint = endpoint;
        this.fallbackValue = fallbackValue;
    }

    void setPeer(SetProperty<E> peer) {
        if (observable != null) {
            if (this.peer != null) {
                this.peer.unbind();
            }
