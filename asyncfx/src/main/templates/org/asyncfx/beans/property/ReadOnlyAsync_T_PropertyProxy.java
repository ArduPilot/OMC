...
class ReadOnlyAsync${boxedType}PropertyProxy$!{genericType} extends ReadOnlyAsync${boxedType}Property$!{genericType} {
    ...
    private ReadOnlyAsync${boxedType}Property$!{genericType} peer;

    ReadOnlyAsync${boxedType}PropertyProxy(PropertyPath.PropertyPathSegment endpoint, $primType fallbackValue) {
        this.endpoint = endpoint;
        this.fallbackValue = fallbackValue;
    }

    synchronized void setPeer(ReadOnlyAsync${boxedType}Property$!{genericType} peer) {
        this.peer = peer;
