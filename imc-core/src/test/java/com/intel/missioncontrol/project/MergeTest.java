...
import com.intel.missioncontrol.project.hardware.HardwareConfigurationSnapshot;
...
class MergeTest extends TestBase {
    ...
    class ValueMergeTests {
        ...
        class NonConflictingChangesTest {
            ...
            @Test
            void SimpleProperty_Unchanged_Merge_NoConflict() {
                double val = 10.01;
            ...
            @Test
            void ObjectProperty_Unchanged_Merge_NoConflict() {
                String val = "Hello1";
                String val2 = "Hello1";
            ...
            @Test
            void IMergableObjectProperty_Unchanged_Merge_NoConflict() {
                ...
                flightPlanProp.init(flightPlan);
            ...
            @Test
            void ListProperty_Unchanged_Merge_NoConflict() {
                String name = "Hello FlightPlan";
            ...
            @Test
            void SimpleProperty_LeftChangedRightNotChanged_Merge_NoConflict() {
                double val = 10.01;
                TrackingAsyncDoubleProperty double1 = new TrackingAsyncDoubleProperty(this);
                double1.init(val);
            ...
            @Test
            void ObjectProperty_LeftChangedRightNotChanged_Merge_NoConflict() {
                String val = "Hello1";
                String val2 = "Hello2";
                TrackingAsyncStringProperty string1 = new TrackingAsyncStringProperty(this);
                string1.init(val);
            ...
            @Test
            void IMergableObjectProperty__LeftChangedRightNotChanged_Merge_NoConflict() {
                var strategy = new MergeStrategy.DryRun();
                String name = "Hello FlightPlan";
            ...
            @Test
            void ListProperty_LeftChangedRightNotChanged_Merge_NoConflict() {
                String name = "Hello FlightPlan";
                FlightPlanSnapshot flightPlanSnapshot =
                    new FlightPlanSnapshot(
                        UUID.randomUUID(),
            ...
            @Test
            void SimpleProperty_LeftNoChangeRightChanged_Merge_NoConflict() {
                double val = 10.01;
                double val1 = 10.02;
                double val2 = 10.03;
                TrackingAsyncDoubleProperty double1 = new TrackingAsyncDoubleProperty(this);
            ...
            @Test
            void ObjectProperty_LeftNoChangeRightChanged_Merge_NoConflict() {
                String val = "Hello1";
                String val2 = "Hello2";
                TrackingAsyncStringProperty string1 = new TrackingAsyncStringProperty(this);
                string1.init(val);
            ...
            @Test
            void IMergableObjectProperty_LeftNoChangeRightChanged_Merge_NoConflict() {
                String name = "Hello FlightPlan";
                FlightPlanSnapshot flightPlanSnapshot =
                    new FlightPlanSnapshot(
                        UUID.randomUUID(),
            ...
            @Test
            void ListProperty_LeftNoChangeRightChanged_Merge_NoConflict() {
                String name = "Hello FlightPlan";
            ...
            @Test
            void CompositeObject_LeftNoChangeRightChanged_Merge_NoConflict() {
                ...
                asMutable(userLeft.nameProperty()).init(userName);
                var userRight = new User(userLeft);
                asMutable(userRight.nameProperty()).init(userName);

                asMutable(left.userProperty()).init(userLeft);
                ...
                asMutable(right.userProperty()).init(userRight);
        ...
        class ConflictingChangesTest {
            ...
            class ValueConflicts {
                ...
                @Test
                void CompositeObject_LeftChangedRightChanged_Merge_Conflict() {
                    var date1 = OffsetDateTime.parse("2019-01-01T00:00:01Z");
                    Project left = new Project();
                    asMutable(left.creationDateProperty()).set(date1);
                    asMutable(left.lastModifiedDateProperty()).set(date1);
    ...
    class TreeMergeTests {
        ...
        class NonConflictingChangesTest {
            ...
            void ListProperty_LeftChangedRightNotChanged_Merge_NoConflict() {
                ...
                flightPlansListProperty2.init(list);
        ...
        class ConflictingChangesTest {
            @Test
            void ListProperty_LeftTreeChangedRightTreeChangedPlusValueChanged_Merge_Conflict() {
                String name = "Hello FlightPlan";
                FlightPlanSnapshot flightPlanSnapshot =
                    new FlightPlanSnapshot(
                        UUID.randomUUID(),
            ...
            @Test
            void ListProperty_LeftTreeChangedRightTreeChangedPlusValueChanged_Merge_KeepOur_ConflictResolved() {
                String name = "Hello FlightPlan";
                var modifiedDate = OffsetDateTime.now();
                FlightPlanSnapshot flightPlanSnapshot =
                    new FlightPlanSnapshot(
                ...
                // flightPlan should stay flightPlan2 was deleted on our side - so deleted after merge
                assertEquals(1, flightPlansListProperty1.size());
            }

            @Test
            void ListProperty_LeftTreeChangedRightTreeChangedPlusValueChanged_Merge_KeepTheir_ConflictResolved() {
                String name = "Hello FlightPlan";
                FlightPlanSnapshot flightPlanSnapshot =
                    new FlightPlanSnapshot(
                        UUID.randomUUID(),
            ...
            @Test
            void ListProperty_LeftTreeChangedPlusValueChangedRightTreeChanged_Merge_Conflict() {
                String name = "Hello FlightPlan";
                var modifiedDate = OffsetDateTime.now();
                FlightPlanSnapshot flightPlanSnapshot =
                    new FlightPlanSnapshot(
            ...
            @Test
            void ListProperty_LeftTreeChangedPlusValueChangedRightTreeChanged_Merge_KeepOurs_ConflictResolved() {
                String name = "Hello FlightPlan";
                var modifiedDate = OffsetDateTime.now();
                FlightPlanSnapshot flightPlanSnapshot =
                    new FlightPlanSnapshot(
            ...
            @Test
            void ListProperty_LeftTreeChangedPlusValueChangedRightTreeChanged_Merge_KeepTheir_ConflictResolved() {
                String name = "Hello FlightPlan";
                var modifiedDate = OffsetDateTime.now();
                FlightPlanSnapshot flightPlanSnapshot =
                    new FlightPlanSnapshot(
                        ...
                        name,
                        OffsetDateTime.now(),
                        new HardwareConfigurationSnapshot(UUID.randomUUID(), null, null, null),
                        new Vec4(0, 0, 0, 0),
                        new Vec4(0, 0, 0, 0),
                        0.0,
                        0.0,
